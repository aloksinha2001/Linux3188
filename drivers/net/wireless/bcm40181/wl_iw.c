...
#define WL_TRACE(x) //	printf x//IAM
#define WL_ASSOC(x) //	printf x//IAM
#define WL_INFORM(x) //	printf x//IAM
#define WL_WSEC(x) //	printf x//IAM
#define WL_SCAN(x) //	printf x//IAM
