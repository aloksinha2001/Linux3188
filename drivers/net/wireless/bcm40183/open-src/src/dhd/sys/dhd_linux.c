...
#ifdef SOFTAP
		/* skip suspend if apsta/ap enabled. */
		if ( dhd_apsta || ap_fw_loaded) return 0;
#endif
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	//}
#endif /* WL_CFG80211 */
	setbit(eventmask, WLC_E_ASSOCREQ_IE); //penguin, tempoary remove since firmware not patch yet.
